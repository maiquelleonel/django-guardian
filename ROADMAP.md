# 🗺️ django-guardian Roadmap & Feature Backlog

This document outlines the planned future features, custom checks, and enhancements for **django-guardian**. We highly welcome contributions from the open-source community to help realize these milestones!
...
### 1. 🎨 Static Template DB Call Auditor (`guardian.W008`)
...
### 2. ⚡ Serializer Nested N+1 Watchdog (`guardian.W009`)
...
### 3. 🚨 Transactional Background Task Guard (`guardian.W010`)
...
### 🗄️ 4. Dangerous Migration Guard (`guardian.W011`)
